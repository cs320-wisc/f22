...
* Apr 5: clarified requirements for SIC code regex (see [corresponding lab page](https://github.com/cs320-wisc/f22/tree/main/labs/edgar-util)) and updated `module_tester.py` expected output
